...
$pdf->Cell(290, 7, 'PERATURAN STANDART UPM', 0, 1, 'C');
$pdf->Cell(50, 10, '', 0, 1);
...
$pdf->Cell(146, 6, 'Detail Peraturan Standart', 1, 1, 'C');
$nomor = 1;
$pdf->SetFont('Arial', '', 10);

include '../koneksi/koneksi.php';
$id_user = $_SESSION['petugas']['id_user'];
$data_standart = mysqli_query($konek, "SELECT * FROM tbl_standart 
...
WHERE user.id_user='$id_user' AND tbl_standart.tgl_upload BETWEEN '$tgl_awal' AND '$tgl_akhir'");
while ($row = mysqli_fetch_array($data_standart)) {
    ...
    $pdf->Cell(146, 6, $row['keterangan_standart'], 1, 1);
}
