    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Detail Peraturan SK Rektor</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item active">Detail Peraturan SK Rektor</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="my-3 text-cyan" align="center">DATA SK REKTOR</h5>
                            ...
                            <p class="text text-md">Di Upload : <?php echo date('d F Y', strtotime($pecah_sk_rektor['tgl_upload'])); ?></p>
                            <p class="text text-md">TENTANG : <?php echo $pecah_sk_rektor['tentang']; ?></p>
                            <?php
                            $hapus_file_lama_saya = $pecah_sk_rektor['upload_sk_rektor'];
                            if (!file_exists("../data_sk_rektor/$hapus_file_lama_saya")) { ?>
                                Data File : <p class="text-danger">Data File Tidak Di Temukan. Kemungkinan Terhapus</p>
                            <?php } else { ?>
