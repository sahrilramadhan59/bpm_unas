    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Tambah Pedoman</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="index">Home</a></li>
                            <li class="breadcrumb-item active">Form Tambah Pedoman</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Form Tambah Pedoman</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Keterangan Pedoman *</label>
                                        ...
                                        if (in_array($ext, $valid)) {
                                            if ($size < (1024 * 1024 * 2)) {
                                                ...
                                                if (move_uploaded_file($lokasi, $folder . $nama_file)) {
                                                    $konek->query("INSERT INTO tbl_pedoman(id_user, id_level, keterangan_pedoman, upload_pedoman, tgl_upload)
                                                    ...
                                                    echo "<script>location='index?halaman=tambah_pedoman'</script>"; //Redirect(Melakukan) Kembali ke Halaman tambah_data
                                                }
                                            } else {
