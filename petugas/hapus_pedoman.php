...
if (isset($_POST["hapus"])) {
    ...
    for ($i = 0; $i < sizeof($kode_pedoman); $i++) {
        ...
        WHERE tbl_pedoman.id_pedoman='$kode_pedoman[$i]' AND tbl_pedoman.id_user='$id_user'"); //Ini untuk mengambil data 
        ...
        $Cek = $konek->query("DELETE FROM tbl_pedoman WHERE id_pedoman='$kode_pedoman[$i]' AND id_user='$id_user'");
