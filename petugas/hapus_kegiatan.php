...
if (isset($_POST["hapus"])) {
    ...
    for ($i = 0; $i < sizeof($kode_kegiatan); $i++) {
        ...
        WHERE tb_kegiatan.id_kegiatan='$kode_kegiatan[$i]' AND tb_kegiatan.id_user='$id_user'"); //Ini untuk mengambil data 
        ...
        $Cek = $konek->query("DELETE FROM tb_kegiatan WHERE id_kegiatan='$kode_kegiatan[$i]' AND id_user='$id_user'");
