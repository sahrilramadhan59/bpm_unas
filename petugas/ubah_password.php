                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            if (isset($_POST["ubah"])) {
                                ...
                                $id_user = $_SESSION["petugas"]["id_user"]; //Ambil Id_Petugas Di Dalam Session.
                                $ambil = $konek->query("SELECT * FROM user WHERE id_user='$id_user' AND password=md5('$password_lama')");
                                ...
                                //Selain Itu. Atau jika password baru dan konfirmasi password sama. 
                                    ...
                                    $konek->query("UPDATE user SET password=md5('$password_baru') WHERE id_user='$id_user'");
