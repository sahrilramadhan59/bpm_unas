...
$db_name	= 'bpm_unas'; //nama database dari database kita. #NOTE: disini saya menggunakan nama database saya dengan 'akademik1', dan bisa kita ganti 								nama database kita sesaui kebutuhan kita.
