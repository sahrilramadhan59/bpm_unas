...
<head>
  ...
  <!-- Favicons -->
  <link rel="icon" type="image/png" href="assets/dist/img/bpm_unas.jpeg">
  <link href="Template_Home/assets/img/bpm_unas.jpeg" rel="icon" type="image/png">
  ...
  <link rel="stylesheet" type="text/css" href="Template_Home/assets/vendor/bootstrap/css/bootstrap.min.css">
  <script src="Template_Home/assets/vendor/bootstrap/js/bootstrap.min.js"></script>
...
<body>
    ...
    <div class="container d-flex h-100">
      <div class="row justify-content-center align-self-center">
        <div class="col-md-6 intro-info order-md-first order-last">
          <h2>BADAN PENJAMINAN<br><span>MUTU</span></h2>
          <div>
        ...
        <div class="col-md-6 intro-img order-md-last order-first">
          <div class="carousel slide" id="gambar_depan" data-ride="carousel">
            <!-- indikator -->
            <ol class="carousel-indicators">
              <li data-target="#gambar_depan" data-slide-to="0" class="active"></li>
              <li data-target="#gambar_depan" data-slide-to="1"></li>
              <li data-target="#gambar_depan" data-slide-to="2"></li>
            </ol>

            <!-- Deklarasi Gambar Carousel -->
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="assets/dist/img/perpus2.jpg" alt="" class="d-block w-100">
                <div class="carousel-caption">
                  <h3>TEST 1</h3>
                  <p>Gambar Berjalan 1</p>
                </div>
              </div>
              <div class="carousel-item">
                <img src="assets/dist/img/perpus2.jpg" class="d-block w-100">
                <div class="carousel-caption">
                  <h3>TEST 2</h3>
                  <p>Gambar Berjalan 2</p>
                </div>
              </div>
              <div class="carousel-item">
                <img src="assets/dist/img/perpus2.jpg" alt="" class="d-block w-100">
                <div class="carousel-caption">
                  <h3>TEST 3</h3>
                  <p>Gambar Berjalan 3</p>
                </div>
              </div>
            </div>

            <!-- Membuat Panah -->
            <a class="carousel-control-prev" href="#gambar_depan" role="button" data-slide="prev">
              <span class="fa fa-chevron-left" aria-hidden="true"></span>
              <span class="sr-only">Previous</span>
            </a>
            <a class="carousel-control-next" href="#gambar_depan" role="button" data-slide="next">
  ...
  <main id="main">
      ...
      <div class="container">
        <div class="row counters">
          <div class="col-lg-3 col-6 text-center">
            <span data-toggle="counter-up"><?php //echo $data_anggota['jumlah']; 
                                            ?></span>
            <p>Anggota</p>
          </div>
          ...
          <div class="col-lg-3 col-6 text-center">
            <span data-toggle="counter-up"><?php //echo $data_buku['jumlah_buku']; 
                                            ?></span>
            <p>Buku</p>
          </div>
          ...
          <div class="col-lg-3 col-6 text-center">
            <span data-toggle="counter-up"><?php //echo $data_pinjam['jumlah_pinjam']; 
                                            ?></span>
          ...
          <!-- ======= Akhir Menghitung Jumlah Buku Yang Di Pinjam ======= -->
          <div class="col-lg-3 col-6 text-center">
            <span data-toggle="counter-up"><?php //echo $data_tersedia['buku_tersedia']; 
                                            ?></span>
    ...
    ?>
    <!-- <li data-filter=".<?php //echo $pecah_kategori["nama_kategori"]; 
                            ?>"><?php //echo $pecah_kategori["nama_kategori"]; 
                                ?></li> -->
    <?php //} 
    ?>
    <!-- </ul>
    ...
    <!-- <div class="col-lg-4 col-md-6 portfolio-item <?php //echo $pecah_buku["nama_kategori"]; 
      ...
      <div class="portfolio-wrap">
        <img src="foto_buku/<?php //echo $pecah_buku['foto_buku']; 
                            ?>" class="img-fluid" alt="">
        <div class="portfolio-info">
          <h4><a href="#"><?php //echo $pecah_buku['judul_buku']; 
                          ?></a></h4> -->
    <!-- <p><?php //echo $pecah_buku['nama_kategori']; 
            ?></p>
          <div>
            <a href="foto_buku/<?php //echo $pecah_buku['foto_buku']; 
                                ?>" data-gall="portfolioGallery" title="Perbesar" class="link-preview venobox"><i class="ion ion-eye"></i></a>
            <a href="detail?id=<?php //echo encrypt($pecah_buku['id_buku']); 
                                ?>" class="link-details" title="Lihat Detail"><i class="ion ion-android-open"></i></a>
            <a href="pinjam?id=<?php //echo encrypt($pecah_buku['id_buku']); 
                                ?>" class="link-details" title="Pinjam Buku"><i class="ion ion-ios-book"> </i></a>
          </div> -->
    <!-- </div>
    </div>
    </div>
          ...
          <div class="col-lg-8">
            <div class="owl-carousel testimonials-carousel wow fadeInUp">
              ...
              <div class="testimonial-item">
                <img src="foto_anggota/<?php //echo $saran["foto"]; 
                                        ?>" class="testimonial-img" alt="">
                <h3><?php //echo $saran["nama_anggota"]; 
                    ?></h3>
                <h4><?php //echo $saran["email_anggota"]; 
                    ?></h4>
                <p>
