                                    ...
                                    <tbody>
                                        ...
                                        <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <center>
                                                        <a href="index?halaman=detail_pedoman&id=<?php echo encrypt($pecah['id_pedoman']); ?>&user=<?php echo encrypt($pecah['id_user']); ?>" class="btn btn-default" title="Edit Data Pedoman"><i class="fas fa-eye"> </i></a>
                                                    </center>
                                                </td>
                                            </tr>
                                            <?php $nomor++; ?>
