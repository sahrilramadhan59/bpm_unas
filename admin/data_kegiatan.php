            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="index?halaman=hapus_kegiatan" method="POST" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                        ...
                                        <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="index?halaman=detail_kegiatan&id=<?php echo encrypt($pecah['id_kegiatan']); ?>&user=<?php echo encrypt($pecah['id_user']); ?>" class="btn btn-default" title="Detail Data Kegiatan"><i class="fas fa-eye"> </i></a>
                                                </td>
                                            </tr>
                                            <?php $nomor++; ?>
                                        <?php } ?>
