                  ...
                  <tbody>
                    ...
                    <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                      <tr>
                        ...
                        <td>
                          <center>
                            <a href="index?halaman=detail_standart&id=<?php echo encrypt($pecah['id_standart']); ?>&user=<?php echo encrypt($pecah['id_user']); ?>" class="btn btn-default" title="Detail Data standart"><i class="fas fa-eye"> </i></a>
                          </center>
                        </td>
                      </tr>
                      <?php $nomor++; ?>
